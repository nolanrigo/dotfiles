...

{
  programs.rofi = {
    ...
    '';
    theme = "${config.home.homeDirectory}/dotfiles/resources/base16-rofi/themes/base16-${config.home.sessionVariables.COLORTHEME}.rasi";
  ...
  #  text = ''
  #    EDITOR='${pkgs.termite}/bin/termite -e nvim --'
